...
| 操作 | 内容 |
| --- | --- |
| ドラッグ | 地図を移動（経度方向は無限にループ） |
| ホイール | ズーム |
| クリック | その地点を調査（気候・バイオーム・そこに棲む生物） |
| ミニマップをクリック | その位置へジャンプ |
| <kbd>1</kbd> <kbd>2</kbd> <kbd>3</kbd> | 三畳紀 / ジュラ紀 / 白亜紀 |
| <kbd>R</kbd> | 再生成 ・ <kbd>L</kbd> 地名 ・ <kbd>F</kbd> 全体表示と拡大表示の切替 |
...
│   ├── renderer.js      ビュー変換・ラベル・名所・スケールバー
│   └── palette.js       カラーランプ
